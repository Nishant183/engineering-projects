...
public class FeeDetails extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\Nishant Kumar\\Documents\\NetBeansProjects\\Hostel_Mangement_System\\images\\1419857809.jpg")); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Fee Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(102, 102, 255))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Total Amount", "Amount Pay", "Remaining"
            }
        ));
...
String query1="insert into FeeDetails values('"+jTextField4.getText()+"','"+jTextField1.getText()+"',"
             + "'"+jTextField7.getText()+"','"+jTextField6.getText()+"','"+jTextField3.getText()+"',"
             + " '"+jTextField5.getText()+"');";
...
Object []newRow={jTextField1.getText(),jTextField7.getText(),jTextField3.getText(),jTextField5.getText()};
DefaultTableModel t;
